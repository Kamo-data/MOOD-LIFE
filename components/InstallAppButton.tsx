  ...
  const modalContent = (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center bg-black/70 px-4 backdrop-blur-md">
      <div
        className={
          isDark
            ? "max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[2rem] border border-white/10 bg-slate-950 p-6 text-left text-slate-200 shadow-2xl"
            : "max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[2rem] border border-slate-200 bg-white p-6 text-left text-slate-700 shadow-2xl"
        }
      >
        ...
        >
          ...
          peuvent afficher un avertissement parce que l’application n’est pas
          encore publiée sur les stores officiels.
        </div>
